            ...
            function displayControls(sectionData, controlsList, sectionName) {
                if (sectionData) {
                    ...
                    sectionData.forEach((control) => {
                        ...
                        <td style="max-width: 45% !important; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${control.point_of_focus}</td>
                        <td style="max-width: 45% !important; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${control.control_activity}</td>
