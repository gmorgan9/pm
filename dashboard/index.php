                      ...
                      <div class="container">
                        <ul class="timeline">
                          <?php
                            $current_date = date('Y-m-d');
                            $current_time = date('H:i:s');
                            $sql = "SELECT * FROM meetings WHERE (date > '$current_date') OR (date = '$current_date' AND end_time >= '$current_time') ORDER BY date ASC, start_time ASC LIMIT 3";
                            ...
                            <div class="timeline-body">
                              ...
                              <div class="timeline-content">
                                ...
                                <p class="text-muted" style="margin-top: -15px;">
                                  ...
                                  <a class="title" style="font-weight: 400 !important;" href="#" data-bs-toggle="modal" data-bs-target="#noteModal<?php echo $id; ?>" class="view">Add Meeting Note</a>
                                </p>
                              </div>
                            </div>
                          </li>
